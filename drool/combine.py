...
def combine_data(mons_data: Dict[int, Dict[str, Any]], 
                moves_by_mon: Dict[str, List[Dict[str, Any]]], 
                abilities_by_mon: Dict[str, Dict[str, str]]) -> Dict[int, Dict[str, Any]]:
...
def generate_typescript_const(data: Dict[int, Dict[str, Any]], output_file: str):
    ...
    type_values = ['Yin', 'Yang', 'Earth', 'Water', 'Fire', 'Metal', 'Ice', 'Nature', 'Lightning', 'Mythic', 'Air', 'Mind', 'Cyber', 'Wild', 'Cosmic']
    for type_value in type_values:
        json_str = re.sub(f'"{type_value}"', f'Type.{type_value}', json_str)

    # Create TypeScript const declaration
    typescript_content = f"""// Auto-generated TypeScript const from CSV data
// Generated by combine_data.py
